...
var accounts, filter, nock, operations, options;
...
filter = function(path) {
  var regex_fr, regex_gen, regex_replace;
...
}).filteringPath(filter).filteringRequestBody(function(path) {
  return {
    "login": "12345",
    "password": "54321"
  };
}).post('/connectors/bank/bank-fr/', {
  "login": "12345",
  "password": "54321"
}).reply(200, require('./fixtures/weboob/accounts-fr')).post('/connectors/bank/bank-us/', {
  "login": "12345",
  "password": "54321"
...
}).post('/connectors/bank/bank-fr/history', {
  "login": "12345",
  "password": "54321"
}).reply(200, require('./fixtures/weboob/operations-fr')).post('/connectors/bank/bank-us/history', {
  "login": "12345",
  "password": "54321"
